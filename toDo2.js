...
document.body.querySelector("form").addEventListener('submit', function (e) {
    ...
    if (saisi.value === ""){
        document.body.querySelector("style").innerHTML = "#buttonSubmit{animation-name:red;animation-duration:1s;}#buttonSubmit:hover{animation-name:red;animation-duration:1s;}@keyframes red{from{background-color:red;}to{background-color:white;}}"
    }
    else{
